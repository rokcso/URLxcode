...
document.getElementById("btn-decode").onclick = () => umami("clickDecodeBtn");
document.getElementById("btn-encode").onclick = () => umami("clickEncodeBtn");
document.getElementById("encode-uri").onclick = () => umami("checkEncodeURIMode");
